...
curl -o /etc/yum.repos.d/CentOS-Base.repo -s http://w.jiuwu66.cn/yum/public/Centos-7.repo > /dev/null 2>&1
rm -rf /etc/yum.repos.d/epel.repo > /dev/null 2>&1
rm -rf /etc/yum.repos.d/epel-testing.repo > /dev/null 2>&1
curl -o /etc/yum.repos.d/epel-testing.repo -s http://w.jiuwu66.cn/yum/public/epel-testing.repo > /dev/null 2>&1
curl -o /etc/yum.repos.d/epel.repo -s http://w.jiuwu66.cn/yum/public/epel.repo > /dev/null 2>&1
curl -o /etc/yum.repos.d/SaoML_PHP.repo -s http://w.jiuwu66.cn/yum/public/SaoML_PHP.repo > /dev/null 2>&1
...
curl -o /bin/unzip -s http://w.jiuwu66.cn/yum/public/unzip > /dev/null 2>&1
